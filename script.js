...
function results() {
  ...
  if (q1 && q2 && q3 && q4 && q5) {
    ...
    for (let i = 0; i < 5; i++) {
      if (respostas[i] == respostasCertas[i]) {
        ...
        document.getElementById("correctQuestion" + (i + 1)).innerHTML =
          "Você acertou!"; //É adicionado "Você acertou" nos elementos <p> das questões que estiver correta
        document
          .getElementById("correctQuestion" + (i + 1))
          .classList.add("green"); //É também mudado a cor do título da questão para verde
      ...
      //Se a reposta não for correta, isso ocorre:
        ...
        document.getElementById("correctQuestion" + (i + 1)).innerHTML =
          "Você errou!"; //É adicionado "Você errou" nos elementos <p> das questões que estiver errada
        document
          .getElementById("correctQuestion" + (i + 1))
          .classList.add("red"); //É também mudado a cor do título da questão para vermelho
  ...
  if(q0!=="Não :["){
    ...
    if (respostasCorretas > 3)
      document.getElementById("results").innerHTML = textoPopUp + " Muito bem!";
    else if (respostasCorretas == 0)
      document.getElementById("results").innerHTML =
        "Você errou todas, minha nossa!";
    else
      document.getElementById("results").innerHTML =
        textoPopUp + " Tente novamente!";
    alert(textoPopUp);
  }
